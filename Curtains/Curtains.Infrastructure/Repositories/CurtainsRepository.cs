...
namespace Curtains.Infrastructure.Repositories
{
    ...
    public class CurtainsRepository : ICurtainsRepository
    {
        ...
        private IQueryable<CurtainsModel> Query => _curtainsContext.Curtains.Include(x => x.Fabric).Include(x => x.Fabric.Color)
            .Include(x => x.CurtainsType).Include(x => x.CurtainsKind).Include(x => x.Material);
        #endregion
